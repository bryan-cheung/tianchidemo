...
//                    LOGGER.info("getWrong:" + batchPos + ", traceIdsize:" + traceIdBatch.getTraceIdList().size() + ",result:" + map.size() + ", in " + (System.currentTimeMillis() - start));
               // }
...
//                LOGGER.info("Done backend batching in {}", System.currentTimeMillis() - start);
            } catch (Exception e) {
